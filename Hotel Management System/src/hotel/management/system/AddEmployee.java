...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee() {
        ...
        lbname.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbname);
        ...
        lbage.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbage);
        ...
        lbgender.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbgender);
        ...
        lbjob.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbjob);
        
        String str[] = {"Front Desk Clerks", "Porters", "HouseKeeping", "Kitchen Staff", "Room Service", "Chefs", "Waiter/Waitress", "Manager", "Accountant", "Supervisor"};
        ...
        lbsalary.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbsalary);
        ...
        lbphone.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbphone);
        ...
        lbemail.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbemail);
        ...
        lbaadhar.setFont(new Font("Raleway",Font.PLAIN, 17));
        add(lbaadhar);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(salary.equals("")) {
            JOptionPane.showMessageDialog(null, "Salary field cannot be empty");
            return;
        }
        if(phone.equals("")) {
        ...
        if(aadhar.equals("")) {
            JOptionPane.showMessageDialog(null, "Aadhar field cannot be empty");
            return;
        }
